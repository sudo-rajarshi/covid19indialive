...
pd_pred_report = pd.read_csv('/home/rajarshi/Documents/Projects/COVIDTRACKER/PRED_REPORTS.csv')
...
with tf.device('/CPU:0'):        
    ...
    for i in range(iterations):
        ...
        callback = [tf.keras.callbacks.EarlyStopping(monitor = 'loss', min_delta = 0.0001, patience = patience, verbose=1, mode = 'min', restore_best_weights = True),
                    tf.keras.callbacks.ModelCheckpoint('/home/rajarshi/Documents/Projects/COVIDTRACKER/best_model_conf.h5', monitor = 'loss', verbose=1, save_best_only=True, save_weights_only=False, mode = 'min' , period=1)]

        model_conf = tf.keras.models.load_model('/home/rajarshi/Documents/Projects/COVIDTRACKER/best_model_conf.h5')
    ...
    for j in range(iterations):
        ...
        callback = [tf.keras.callbacks.EarlyStopping(monitor = 'loss', min_delta = 0.0001, patience = patience, verbose=1, mode = 'min', restore_best_weights = True),
                    tf.keras.callbacks.ModelCheckpoint('/home/rajarshi/Documents/Projects/COVIDTRACKER/best_model_rec.h5', monitor = 'loss', verbose=1, save_best_only=True, save_weights_only=False, mode = 'min' , period=1)]

        model_rec = tf.keras.models.load_model('/home/rajarshi/Documents/Projects/COVIDTRACKER/best_model_rec.h5')
    ...
    for k in range(iterations):
        ...
        callback = [tf.keras.callbacks.EarlyStopping(monitor = 'loss', min_delta = 0.0001, patience = patience, verbose=1, mode = 'min', restore_best_weights = True),
                    tf.keras.callbacks.ModelCheckpoint('/home/rajarshi/Documents/Projects/COVIDTRACKER/best_model_det.h5', monitor = 'loss', verbose=1, save_best_only=True, save_weights_only=False, mode = 'min' , period=1)]

        model_det = tf.keras.models.load_model('/home/rajarshi/Documents/Projects/COVIDTRACKER/best_model_det.h5')
...
df_pred_reports.to_csv('/home/rajarshi/Documents/Projects/COVIDTRACKER/PRED_REPORTS.csv')
...
df_day14.to_html('/home/rajarshi/Documents/Projects/COVIDTRACKER/day14.html', border=0, justify = 'left', index = False)
...
df_reports.to_csv('/home/rajarshi/Documents/Projects/COVIDTRACKER/REPORTS.csv')